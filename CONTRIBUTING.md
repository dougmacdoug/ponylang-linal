...
You want to contribute to ponylang-linal? Awesome.
...
First of all please [search existing issues](https://github.com/dougmacdoug/ponylang-linal/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/dougmacdoug/ponylang-linal/issues/new).
